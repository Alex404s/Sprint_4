...
class TestBooksCollector:
    ...
    def test_add_new_book_incorrect_name_empty_list(self, name):
    ...
    def test_add_new_book_repeat_name_one_book_in_list(self):
    ...
    def test_set_book_genre_set_one_genre(self):
    ...
    def test_get_book_genre_no_added_genre_empty_genre(self):
    ...
    def test_get_books_with_specific_genre_add_two_books_fantastic(self):
    ...
    @pytest.mark.parametrize('name, genre', [['Война миров' , 'Фантастика'],
                                             ['Челюсти' , 'Ужасы'],
                                             ['Евангелион' , 'Мультфильмы']])
    def test_get_books_genre_view_three_books_with_genre(self, name, genre):
    ...
    @pytest.mark.parametrize('name, genre', [['Незнайка' , 'Фантастика'],
                                             ['Мулан' , 'Мультфильмы'],
                                             ['День сурка' , 'Комедии']])
    def test_get_books_for_children_add_fantastic_cartoon_comedy_books(self, name, genre):
    ...
    def test_delete_book_from_favorites_delete_one_book_empty_favorites(self):
    ...
    def test_get_list_of_favorites_books_default_empty(self):
